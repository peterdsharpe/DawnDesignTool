...
mass_payload_base = 6 # kg, the mass of the payload from Brent email 5/22
payload_power = 80 # W, the power of the payload from Brent email 5/22
...
swath_overlap = 0.1 # not currently used
...
# define flight path angle gamma
gamma = np.arctan2d(dyn.w_e, dyn.u_e)
# add drag force to dynamics buildup
dyn.add_force(
    Fx=-np.cosd(gamma) * aero['D'],
    Fz=np.sind(gamma) * aero['D'],
    axes="earth"
)
# add lift force to dynamics buildup
dyn.add_force(
...
# add thrust force to dynamics buildup
dyn.add_force(
...
wing_section_A_incident_solar_power = 0.2 * area_solar_wing * lib_solar.solar_flux(
    latitude=latitude,
    day_of_year=day_of_year,
    time=time,
    panel_azimuth_angle=wing_panel_azimuth,
    panel_tilt_angle=47 - dyn.alpha,
    scattering=True
)
wing_section_B_incident_solar_power = 0.2 * area_solar_wing * lib_solar.solar_flux(
    latitude=latitude,
    day_of_year=day_of_year,
    time=time,
    panel_azimuth_angle=wing_panel_azimuth,
    panel_tilt_angle=12 - dyn.alpha,
    scattering=True
)
wing_section_C_incident_solar_power = 0.2 * area_solar_wing * lib_solar.solar_flux(
    latitude=latitude,
    day_of_year=day_of_year,
    time=time,
    panel_azimuth_angle=wing_panel_azimuth,
    panel_tilt_angle=-5 - dyn.alpha,
    scattering=True
)
wing_section_D_incident_solar_power = 0.2 * area_solar_wing * lib_solar.solar_flux(
    latitude=latitude,
    day_of_year=day_of_year,
    time=time,
    panel_azimuth_angle=wing_panel_azimuth,
    panel_tilt_angle=-14 - dyn.alpha,
    scattering=True
)
wing_section_E_incident_solar_power = 0.2 * area_solar_wing * lib_solar.solar_flux(
    latitude=latitude,
    day_of_year=day_of_year,
    time=time,
    panel_azimuth_angle=wing_panel_azimuth,
    panel_tilt_angle=-11 - dyn.alpha,
    scattering=True
)

wing_incident_solar_power = wing_section_A_incident_solar_power + \
                            wing_section_B_incident_solar_power + \
                            wing_section_C_incident_solar_power + \
                            wing_section_D_incident_solar_power + \
                            wing_section_E_incident_solar_power
...
opti.subject_to([
    ...
    dyn.w_e[time_periodic_end_index] == dyn.w_e[time_periodic_start_index],
