...
# Aircraft Parameters
battery_specific_energy_Wh_kg = opti.parameter(value=600)  # cell level specific energy of the battery
...
## ranges from -15 to -30 dB for grassland
...
if trajectory == 'lawnmower':
    required_revisit_rate = 24 / temporal_resolution
