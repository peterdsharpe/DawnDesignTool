...
if aerodynamics_type == "buildup":
    ...
    hstab_Cl_inc = hstab_airfoil.CL_function(alpha + hstab.mean_twist_angle(), hstab_Re, 0,
                                             0)  # Incompressible 2D lift_force coefficient
    ...
    hstab_Cd_profile = hstab_airfoil.CDp_function(alpha + hstab.mean_twist_angle(), hstab_Re, mach, 0)
