...
r_values = np.linspace(0.001, 15, n)  # Adjust the range and number of points as needed
...
for i in range(n):
    for j in range(n):
        ...
        strain_rate_matrix[i, j] =((A * deviatoric_stress ** 3) * 3.154e+7)
