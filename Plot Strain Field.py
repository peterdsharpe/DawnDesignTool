...
fracture_toughness = np.linspace(10, 100, 10)
fracture_toughness = [100]
for k_i in fracture_toughness:
    ...
    plt.title('Deviatoric Stress Contour Plot for Fracture Toughness = ' + str(k_i) + ' kPa m^0.5')
    ...
    # save the plot
    plt.savefig('strain_rate/Stress' + str(k_i) + '.png')
    ...
    # Set the title and labels
    plt.title('Strain Rate Contour Plot for Fracture Toughness = ' + str(k_i) + ' kPa m^0.5')
    plt.xlabel('X [meters]')
    plt.ylabel('Y [meters]')
    plt.xlim(-plotting_range, plotting_range)
    plt.ylim(-plotting_range, plotting_range)
    ...
    # save the plot
    plt.savefig('strain_rate/StrainRate' + str(k_i) + '.png')
    # Show the plot
    plt.show()
